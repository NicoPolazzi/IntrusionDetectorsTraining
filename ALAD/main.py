...
def run(args):
    print("Running with customized settings")
...
if __name__ == "__main__":
    ...
    parser.add_argument('dataset', nargs="?", choices=['mnist', 'kdd', 'adfa', 'cicids'], help='the name of the dataset you want to run the experiments on, mnist, kdd, adfa, cicids')
